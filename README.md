...
<p align="center">
  <a href="https://www.npmjs.com/package/@npmtuanmap2024/dolores-quas-facilis"><img src="https://img.shields.io/npm/dm/@npmtuanmap2024/dolores-quas-facilis.svg" alt="Downloads"></a>
  <a href="https://www.npmjs.com/package/@npmtuanmap2024/dolores-quas-facilis"><img src="https://img.shields.io/npm/v/@npmtuanmap2024/dolores-quas-facilis.svg" alt="Version"></a>
  <a href="https://www.npmjs.com/package/@npmtuanmap2024/dolores-quas-facilis"><img src="https://img.shields.io/npm/l/@npmtuanmap2024/dolores-quas-facilis.svg" alt="License"></a>
</p>
...
```bash
npm i --save-dev @npmtuanmap2024/dolores-quas-facilis
```
...
{   
    "presets": [ "es2015" ],
    "plugins": [["@npmtuanmap2024/dolores-quas-facilis", {"imports": true}]]
}
```
...
React.Fragment is also compiled to inferno createFragment call to ease project migration to Inferno https://github.com/infernojs/@npmtuanmap2024/dolores-quas-facilis/issues/56.
...
#### Imports (boolean)
@npmtuanmap2024/dolores-quas-facilis will automatically import the required methods from inferno library.
...
You can verify `@npmtuanmap2024/dolores-quas-facilis` is used by looking at the compiled output.
